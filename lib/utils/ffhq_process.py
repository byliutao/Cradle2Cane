...
# 读取 JSON 文件
image_dir = "./dataset/ffhq512"
json_path = "./dataset/ffhq-dataset-v2.json"
save_dir = "./dataset/ffhq512_labeled"
info_json_path = "./dataset/json"
...
# CarveKit 初始化
carvekit = CarveKit(None, None, "cuda", torch.float32)
